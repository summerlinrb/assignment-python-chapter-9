...
# No coding. only an introduction of Python Standard Library paths

print("\nChapter 9.2 - Working with Paths " + "-"*20)
...
print(f"Is the pth object a file {path.is_file()}")
